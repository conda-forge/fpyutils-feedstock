...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fpyutils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5917&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fpyutils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fpyutils` can be installed with:

```
conda install fpyutils
```

It is possible to list all of the versions of `fpyutils` available on your platform with:
